    ...
    M: MatrixOperations,
{
    ...
    fn compute_hpr_correction(
        ...
        //     let hb_off_times_rs = DVector::from(wf.approx_matmul_off_diag_variational_no_singles(&rs, ham, excite_gen, eps)); // Perform off-diagonal heat-bath here
        //     println!("Done performing HB...");
        //     println!("{:?}", hb_off_times_rs);
        //     let rs2 = hb_off_times_rs.component_div(&tmp); // first-order heat-bath correction to Davidson-preconditioned correction
